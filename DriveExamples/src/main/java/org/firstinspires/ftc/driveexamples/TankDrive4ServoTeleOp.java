...
/**
 * TeleOp example for a 4-servo tank drive.
 * Left joystick Y  = left side power
 * Right joystick Y = right side power
 */
@TeleOp(name = "Tank Drive - 4 Servo", group = "Drive Examples")
@Disabled
public class TankDrive4ServoTeleOp extends OpMode {
    private ElapsedTime runtime = new ElapsedTime();
    TankDrive4Servo drivetrain;

    @Override
    public void init() {
        // Create the drivetrain object using the hardware map
        drivetrain = new TankDrive4Servo(hardwareMap, telemetry);
